...
using AnimationTest.Helpers;
using AnimationTest.Services;
...
namespace AnimationTest.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<TemplatedControlPagePage>("Shell_TemplatedControlPage".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<ImplicitAnimationPagePage>("Shell_ImplicitAnimationPage".GetLocalized(), Symbol.Document));
        }
